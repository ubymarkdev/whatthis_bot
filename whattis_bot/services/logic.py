...
def procesar_mensaje (mensaje):
    ...
    if (any(p in mensaje for p in ["cuarzo"]) 
    and 
    any(p in mensaje for p in ["negro", "blanco", "claro", "vetas", "este", "similar"])
    ...
    if (any(p in mensaje for p in ["marmol"]) 
    and 
    ...
    if (any(p in mensaje for p in ["granito"]) 
    and 
